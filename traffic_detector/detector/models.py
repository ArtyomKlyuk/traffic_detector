...
class DetectorInitialized(models.Model):  # Надо сделать минимальную длину(validator)
...
class DetectorSetUp(models.Model):
    new_detector = models.ForeignKey(DetectorInitialized, on_delete=models.CASCADE)
